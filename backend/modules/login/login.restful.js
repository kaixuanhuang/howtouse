...
module.exports = function (app) {
    ...
    function attemptLogin(req, res) {
        ...
        // Plain Password
        (personnel, _cb) => {
            if (_req.body.password === personnel['password']) {
                _cb(null, true, personnel);
            } else {
                _cb(null, false, personnel);
            }
        }
        ,
            //222222222
        (results, personnel, _cb) => {
            ...
            personnel.uid = '12345';
            personnel.username= 'admin' ;
            personnel.permission = ['add' ,'delete'];
